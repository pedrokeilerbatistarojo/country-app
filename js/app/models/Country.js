export class Country {
    constructor(data) {
        ...
        this.cca3 = data.cca3; // Mantenemos cca3 aquí para el constructor, si la API lo manda,
                               // lo usaremos internamente para los bordes si es necesario.
                               // Pero la navegación principal será por nombre.
    }
    ...
    // Método para generar el HTML de la tarjeta del país
    toCardHtml(formatNumberFn) {
        // Usamos data-country-name para pasar el nombre del país
        return `
            <div class="country-card" data-country-name="${this.name}">
    ...
    // Método para generar el HTML de la página de detalle del país
            ...
            <div class="border-countries">
                ...
                <div class="border-tags">
                    ${borderCountries.map(border => `
                        <span class="border-tag" data-country-name="${border.code}">
                            ${border.name}
                        </span>
                    `).join('')}
                </div>
